...
public final class App {
    ...
    public static Javalin getApp() {
        ...
        // BEGIN
        app.post(NamedRoutes.postPath("{id}"), PostsController::edit);
        app.get(NamedRoutes.editPath("{id}"), PostsController::editShow);
        app.post(NamedRoutes.editPath("{id}"), PostsController::edit);
        // END
